...
import (
	...
	"github.com/asians-cloud/cs-blackrules-bouncer/pkg/backend"
	"github.com/asians-cloud/cs-blackrules-bouncer/pkg/cfg"
	"github.com/asians-cloud/cs-blackrules-bouncer/pkg/metrics"
	"github.com/asians-cloud/cs-blackrules-bouncer/pkg/version"
)

const (
	name = "crowdsec-blackrule-bouncer"
)
...
func Execute() error {
	var err error
	configPath := flag.String("c", "", "path to crowdsec-blackrule-bouncer.yaml")
	...
	log.Infof("crowdsec-blackrule-bouncer %s", version.VersionStr())
