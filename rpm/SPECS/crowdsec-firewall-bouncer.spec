Name:      crowdsec-blackrule-bouncer-iptables
...
Source1:   80-crowdsec-blackrule-bouncer.preset
...
%global name crowdsec-blackrule-bouncer
...
%config(noreplace) %{_presetdir}/80-crowdsec-blackrule-bouncer.preset
