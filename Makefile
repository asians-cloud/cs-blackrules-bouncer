...
BINARY_NAME=crowdsec-blackrule-bouncer
GO_MODULE_NAME=github.com/asians-cloud/cs-blackrules-bouncer
...
.PHONY: clean-debian
clean-debian:
	@$(RM) -r debian/crowdsec-blackrule-bouncer-iptables
	@$(RM) -r debian/crowdsec-blackrule-bouncer-nftables
	@$(RM) -r debian/files
